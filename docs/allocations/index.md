...
### Are you a researcher  PhD or higher  affiliated to swedish academia and requiring NAISS resources?

Research projects are handled through the [SUPR](https://supr.naiss.se) portal,
so applying/joining Time Allocation and applying for NAISS account must be done via [SUPR](https://supr.naiss.se)
...
* If you are joining a research project that already has a Time Allocation at NAISS, see [Joining an existing Time Allocation](#joining-an-existing-time-allocation).

### Are you a student  Bachelor or Master level  requiring NAISS resources for your thesis?
...
and applying for NAISS account should be done from your [SUPR](https://supr.naiss.se) page.
