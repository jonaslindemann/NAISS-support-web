...
The PDC system usage page lets you view information about how much time different projects have used on Dardel - either on a daily or monthly basis.
...
## Specifying what information is shown on Dardel usage page
...
* On the top row of the Dardel usage page, click on “Allocation” and scroll down to the particular project you are interested in.
  Then click on the project name to select that project.
* On the top row of the Dardel usage page, start typing in the project name in the “Search..” field, and then click on the name of the particular project from the list that will open up under the “Allocation” heading.
...
On the top row of the Dardel usage page, click on *Graph*.

### To view account usage information as a table

On the top row of the Dardel usage page, click on *Table*.

## Viewing usage information per day or per month

### To view account usage information on a daily basis

On the top row of the Dardel usage page, click on *Daily*.

### To view account usage information on a daily basis

On the top row of the Dardel usage page, click on *Monthly*.

## Viewing usage information for Dardel

If you want to know how much time the selected project has used on a particular Dardel, click on the name of that particular
system on the top row of the Dardel usage page.
